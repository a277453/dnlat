...
import ErrorSummary from '../components/panels/ErrorSummary';
...
const CATEGORY_DISPLAY = {
  customer_journals: { label: 'Customer Journals' },
  ui_journals:       { label: 'UI Journals'        },
  trc_trace:         { label: 'TRC Trace'           },
  trc_error:         { label: 'TRC Error'           },
  registry_files:    { label: 'Registry Files'      },
  acu_files:         { label: 'ACU XML Files'       },
};
...
const PANEL_COMPONENTS = {
  ...
  error_summary:           ErrorSummary,  // v5 NEW
};
