              ...
              <div className="fade-in">
                ...
                {canFeedback && (
                  <Expander title="📝 Provide Feedback on AI Analysis" defaultOpen={false}>
                    ...
                    {/* Q1: Rating */}
                    <div className="mb-16">
                      <label style={{ display:'block', marginBottom:6, fontWeight:600, color:'var(--text-primary)', fontSize:13 }}>1️⃣  Rate the Analysis Quality (0–5)</label>
                    ...
                    <div className="mb-16">
                      <SelectField
                        label="2️⃣  Alternative Root Cause (if applicable)"
                        value={fbCause}
                        onChange={setFbCause}
                    ...
                    {/* Q3: Comment */}
                    <div className="mb-16">
                      <label style={{ display:'block', marginBottom:6, fontWeight:600, color:'var(--text-primary)', fontSize:13 }}>3️⃣  Additional Comments</label>
